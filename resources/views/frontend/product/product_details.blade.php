                ...
                @endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<select class="form-control unicase-form-control selectpicker" id="color" style="display: none;">
											...
											{{-- ucwrods capitlize first character --}}
							...
							{{-- end row --}}
							{{-- End Color and sizes Faisal You are the best --}}
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				 <a href="{{url('product/details/'.$product->id.'/'.$product->product_slug_en)}}"><img  src="{{asset($product->product_thmbnail)}}" alt=""></a>
			 </div>
			 <!-- /.image -->			
		   ...
		   <div>
			 @if($product->discount_price == NULL)
			 <div class="tag new"><span>Sales</span></div>
			 @else
